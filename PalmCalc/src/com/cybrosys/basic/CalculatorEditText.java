...
public class CalculatorEditText extends EditText {
	...
	private void show() {
		...
		final Dialog dialog = new Dialog(com.cybrosys.basic.BasicActivity.ctx,
		...
		ma = adapterM.createFromResource(com.cybrosys.basic.BasicActivity.ctx,
		...
		if (getText().length() == 0) {
			if (primaryClip == null || !canPaste(primaryClip)) {
				ma = adapterM.createFromResource(
						com.cybrosys.basic.BasicActivity.ctx,
